...
int main(int argc, char *argv[]) {
  ...
  unsigned char* imageData = (unsigned char*)mmap(NULL, sizeof(infoHeader.biSizeImage), PROT_READ | PROT_WRITE, MAP_SHARED | MAP_ANONYMOUS, -1, 0);
  unsigned char* finalImageData = (unsigned char*)mmap(NULL, sizeof(infoHeader.biSizeImage), PROT_READ | PROT_WRITE, MAP_SHARED | MAP_ANONYMOUS, -1, 0);
